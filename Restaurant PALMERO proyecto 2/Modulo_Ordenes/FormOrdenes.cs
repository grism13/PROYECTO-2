...
namespace Restaurant_PALMERO_proyecto_2.Modulo_Ordenes
{
    public partial class FormOrdenes : Form
    {
        ...
        private void CargarDatosDePrueba()
        {
            ...
            listaDePlatos.Add(new Plato("Hamburguesa Palmero", 15, "Carne", "Brutal", null));
            listaDePlatos.Add(new Plato("Linguinis Especiales", 12, "Pasta", "Ricos", null));
            listaDePlatos.Add(new Plato("Jugo Natural", 5, "Bebida", "Fresco", null));
            listaDePlatos.Add(new Plato("Pizza Familiar", 20, "Pizza", "Grande", null));
